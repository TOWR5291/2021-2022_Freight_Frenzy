...
@TeleOp (name = "Minecraft Drive(Practice)", group = "Gage")
//@Disabled
...
////            currentExtend = currentExtend + 0.2;
//            extendServo.setPosition(.1);
//            telemetry.addData("Servo:", "extended");
//        }else if (gamepad2.left_bumper){
//            currentExtend = currentExtend - 0.2;
//            extendServo.setPosition(.9);
//        }else {
//            extendServo.setPosition(.5);
//        }
